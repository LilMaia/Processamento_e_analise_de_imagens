...
def abrir_imagem(image_label, image_info, result_label=""):
    ...
    if file_path:
        try:
            ...
            image_info.image_resized = image.resize(
...
def atualizar_imagem(image, image_label, image_info, result_label):
